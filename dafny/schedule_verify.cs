// Dafny program schedule_verify.dfy compiled into C#
...
// Command-line arguments: run schedule_verify.dfy
// schedule_verify.dfy
...
class CampDay {
  ...
  constructor (a: seq<Activity>)
    requires forall act: Activity {:trigger act.description} {:trigger act.name} {:trigger act.durationMinutes} {:trigger act in a} :: (act in a ==> act.durationMinutes > 0) && (act in a ==> |act.name| > 0) && (act in a ==> |act.description| > 0)
    decreases a
  {
    activities := a;
  }
  ...
  method ValidateAll() returns (valid: bool)
    ensures valid ==> forall act: Activity {:trigger act.description} {:trigger act.name} {:trigger act.durationMinutes} {:trigger act in activities} :: (act in activities ==> act.durationMinutes > 0) && (act in activities ==> |act.name| > 0) && (act in activities ==> |act.description| > 0)
  {
    valid := true;
    var i := 0;
    while i < |activities|
      invariant 0 <= i <= |activities|
      invariant valid ==> forall j: int {:trigger activities[j]} :: (0 <= j < i ==> activities[j].durationMinutes > 0) && (0 <= j < i ==> |activities[j].name| > 0) && (0 <= j < i ==> |activities[j].description| > 0)
      decreases |activities| - i
    {
      var a := activities[i];
...
namespace _module {
  ...
  public interface _IActivity {
    bool is_Activity { get; }
    Dafny.ISequence<Dafny.Rune> dtor_name { get; }
    BigInteger dtor_durationMinutes { get; }
    Dafny.ISequence<Dafny.Rune> dtor_description { get; }
    _IActivity DowncastClone();
  }
  public class Activity : _IActivity {
    public readonly Dafny.ISequence<Dafny.Rune> _name;
    public readonly BigInteger _durationMinutes;
    public readonly Dafny.ISequence<Dafny.Rune> _description;
    public Activity(Dafny.ISequence<Dafny.Rune> name, BigInteger durationMinutes, Dafny.ISequence<Dafny.Rune> description) {
      this._name = name;
      this._durationMinutes = durationMinutes;
      this._description = description;
    }
    public _IActivity DowncastClone() {
      if (this is _IActivity dt) { return dt; }
      return new Activity(_name, _durationMinutes, _description);
    }
    public override bool Equals(object other) {
      var oth = other as Activity;
      return oth != null && object.Equals(this._name, oth._name) && this._durationMinutes == oth._durationMinutes && object.Equals(this._description, oth._description);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._name));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._durationMinutes));
    ...
    public override string ToString() {
      ...
      s += ", ";
      s += Dafny.Helpers.ToString(this._durationMinutes);
      s += ", ";
      s += this._description.ToVerbatimString(true);
      s += ")";
      return s;
    }
    private static readonly _IActivity theDefault = create(Dafny.Sequence<Dafny.Rune>.Empty, BigInteger.Zero, Dafny.Sequence<Dafny.Rune>.Empty);
    public static _IActivity Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<_IActivity> _TYPE = new Dafny.TypeDescriptor<_IActivity>(Activity.Default());
    public static Dafny.TypeDescriptor<_IActivity> _TypeDescriptor() {
      return _TYPE;
    }
    public static _IActivity create(Dafny.ISequence<Dafny.Rune> name, BigInteger durationMinutes, Dafny.ISequence<Dafny.Rune> description) {
      return new Activity(name, durationMinutes, description);
    }
    public static _IActivity create_Activity(Dafny.ISequence<Dafny.Rune> name, BigInteger durationMinutes, Dafny.ISequence<Dafny.Rune> description) {
      return create(name, durationMinutes, description);
    }
    public bool is_Activity { get { return true; } }
    public Dafny.ISequence<Dafny.Rune> dtor_name {
      get {
        return this._name;
      }
    }
    public BigInteger dtor_durationMinutes {
      get {
        return this._durationMinutes;
      }
    }
    public Dafny.ISequence<Dafny.Rune> dtor_description {
      get {
  ...
  public partial class CampDay {
    public CampDay() {
      this.activities = Dafny.Sequence<_IActivity>.Empty;
    }
    public Dafny.ISequence<_IActivity> activities {get; set;}
    public void __ctor(Dafny.ISequence<_IActivity> a)
    {
      (this).activities = a;
    }
    public bool ValidateAll()
    {
      ...
      while ((_0_i) < (new BigInteger((this.activities).Count))) {
        _IActivity _1_a;
        _1_a = (this.activities).Select(_0_i);
        if (((((_1_a).dtor_durationMinutes).Sign != 1) || ((new BigInteger(((_1_a).dtor_name).Count)).Sign == 0)) || ((new BigInteger(((_1_a).dtor_description).Count)).Sign == 0)) {
          valid = false;
        }
